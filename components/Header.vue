<template lang='pug'>
header.mb-1(class='md:mb-11')
  div(class='md:flex md:justify-between md:items-center')
    h1.text-4xl.mb-4(class='md:mb-0')
      a(href='https://lynnbenson.com/') Lynn Benson 
      | /&nbsp;
      span.text-green-800 Drops
    button.flex.items-center.mt-2.pb-2.border-b-4.border-white(to='/' class='hover:border-green-400' v-if='false')
      .mr-3 More about this project
      .arrow
